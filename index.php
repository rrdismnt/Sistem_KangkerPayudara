...
<html lang="en">
  <head>
    ...
    <title>Cek Kanker Payudara Yuk!</title>
  </head>
  <body>
      ...
      <div class="container">
        <div class="row">
          <div class="col align-self-center">
            <h1 class="mb-4">Ayo Cek Kanker Payudara</h1>
            <p class="mb-4">
              Cek Kanker Payudara! Merupakan sistem informasi berbasis Web Based yang memanfaatkan teknologi Sistem Pakar didalamnya. Dengan menggunakan sistem pakar ini pengguna dapat mengenali atau memeriksakan keluhan terhadap kanker payudara hanya dengan menjawab pertanyaan yang diberikan oleh sistem, dan kemudian pengguna dapat melihat hasil Test dengan hasil yang direpresentasikan dalam bentuk persentase.
            </p>
    ...
    <section id="alur">
      ...
      <div id="konten2" class="container konten">
        <h2 style="font-weight: bold;text-align: center;">Alur Kerja Sistem Pakar Kanker Payudara </h2>
        <div class="card-deck">
          <div class="card">
